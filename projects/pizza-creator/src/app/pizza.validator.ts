...
export const PizzaValidator = (control: FormControl): {[key: string]: boolean} => {
    // 'control' es el formGroup / formControl donde se ha injectado este validador
    // (en este caso, es el this.form)
